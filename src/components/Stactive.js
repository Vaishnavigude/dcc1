...
function Stactive() {
  ...
  return (
    <>
    <Sidenav/>
    <ListGroup as="ol" numbered style={{marginRight: '10px'  ,marginLeft: '200px',border:'2px'}}>
      <ListGroup.Item
        as="li"
        className="d-flex justify-content-between align-items-start ">
        <div className="ms-2 ">
          <div className="fw-bold justify-left text-left" style={{marginRight:'700px'}}>Project 1</div>
          Assigned Site Engineer
        </div>
        <Badge bg="primary" pill className='mt-2.5 mb-2.5'>
        <Link to="/Viewprofile" className=' no-underline text-white '>  Active  </Link>
        </Badge>
        <Badge bg="primary" pill className='mt-2.5 mb-2.5'>
          <Link to="/Viewprofile" className=' no-underline text-white'>View Profile </Link>
        </Badge>
      </ListGroup.Item>
      <ListGroup.Item
        as="li"
      ...
      >
        <div className="ms-2 ">
          <div className="fw-bold" style={{marginRight:'810px'}}>Project 2</div>
          Assigned Site Engineer
        </div>
        <Badge bg="primary" pill className='mt-2.5 mb-2.5'>
          View Profile
      ...
      >
        <div className="ms-2 ">
          <div className="fw-bold" style={{marginRight:'810px'}}>Project 3</div>
          Assigned Site Engineer
        </div>
        <Badge bg="primary" pill className='mt-2.5 mb-2.5'>
        View Profile
      ...
      >
        <div className="ms-2 ">
          <div className="fw-bold" style={{marginRight:'810px'}}>Project 4</div>
          Assigned Site Engineer
        </div>
        <Badge bg="primary" pill className='mt-2.5 mb-2.5'>
          View Profile
      ...
      >
        <div className="ms-2 ">
          <div className="fw-bold" style={{marginRight:'810px'}}>Project 5</div>
          Assigned Site Engineer
        </div>
        <Badge bg="primary" pill className='mt-2.5 mb-2.5'>
          View Profile
      ...
      >
        <div className="ms-2 ">
          <div className="fw-bold" style={{marginRight:'810px'}}>Project 6</div>
          Assigned Site Engineer
        </div>
        <Badge bg="primary" pill className='mt-2.5 mb-2.5'>
          View Profile
      ...
      >
        <div className="ms-2 ">
          <div className="fw-bold" style={{marginRight:'810px'}}>Project 7</div>
          Assigned Site Engineer
        </div>
        <Badge bg="primary" pill className='mt-2.5 mb-2.5'>
          View Profile
      ...
      >
        <div className="ms-2 ">
          <div className="fw-bold" style={{marginRight:'810px'}}>Project 8</div>
          Assigned Site Engineer
        </div>
        <Badge bg="primary" pill className='mt-2.5 mb-2.5'>
          View Profile
      ...
      >
        <div className="ms-2 ">
          <div className="fw-bold" style={{marginRight:'740px'}}>Project 9</div>
          Assigned Site Engineer
        </div>
        <Badge bg="Danger" pill className='mt-3.5 mb-2.5'>
          Active
        </Badge>
        <Badge bg="primary" pill className='mt-2.5 mb-2.5'>
          View Profile
