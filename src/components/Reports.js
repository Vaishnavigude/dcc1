...
function Reports() {
  ...
  return (
    ...
    <Card style={{ width: '18rem', marginLeft:'250px' , marginTop:'60px'}}>
          <Card.Img variant="top" src="pimages/active.png" className='h-44 w-44 rounded'/>
          <Card.Body>
              <Card.Title>Active</Card.Title>
              <Card.Text>
                 Here are the Reports of the projects which are Active.
              </Card.Text>
              <Button variant="primary">Show Reports</Button>
          </Card.Body>  
      </Card>
    <Card style={{ width: '19rem', marginLeft:'575px' ,marginTop:'-183px'}}>
          <Card.Img variant="top" src="pimages/active.png" className='h-44 w-35 rounded' />
          <Card.Body>
              <Card.Title>Completed</Card.Title>
              <Card.Text>
                 Here are the Reports of the projects which are completed by Site Engineer.
              </Card.Text>
              <Button variant="primary">Show Reports</Button>
          </Card.Body>  
    </Card>
    <Card style={{ width: '18rem',  marginLeft:'915px' ,marginTop:'-180px'}}>
          <Card.Img variant="top" src="pimages/active.png" className='h-40 w-20 rounded' />
          <Card.Body>
              <Card.Title>Pending</Card.Title>
              <Card.Text>
                 Here are the Reports of the projects which are Pending by Site Engineer.
              </Card.Text>
              <Button variant="primary">Show Reports</Button>
          </Card.Body>  
    </Card>
